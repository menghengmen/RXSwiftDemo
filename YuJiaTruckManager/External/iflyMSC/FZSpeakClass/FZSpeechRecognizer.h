...
typedef void (^XFAudioVolumnChangeCallback)(int volumn);
...
@property(nonatomic, copy) XFAudioVolumnChangeCallback volumnCallback;
...
+ (void)xf_AudioRecognizerVolumeChanged: (void(^)(int volume))callback;
