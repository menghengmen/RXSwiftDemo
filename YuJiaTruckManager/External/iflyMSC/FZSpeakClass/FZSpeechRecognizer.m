...
- (void)onVolumeChanged:(int)volume{
    [FZSpeechRecognizer sharedInstance].volumnCallback(volume);
}
...
+ (void)xf_AudioRecognizerVolumeChanged:(void (^)(int))callback{
    
    [FZSpeechRecognizer sharedInstance].volumnCallback = callback;
}
